...
class ScheduleAdapter(val schedule: MutableList<mItem>): RecyclerView.Adapter<RecyclerView.ViewHolder>()  {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent!!.context).inflate(R.layout.item_shedule, parent, false)
    ...
    inner class ItemViewHolder(itemView: View)
        ...
        fun bind(position: Int) = with(itemView) {
            val mevent =schedule[position]
            tvTime.text = mevent.time
            tvDescription.text = mevent.info
